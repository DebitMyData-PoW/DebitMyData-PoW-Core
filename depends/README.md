...
DebitMyData Core. It supports cross-compilation. For more details see [description.md](description.md),
...
## Configuring DebitMyData Core

**When configuring DebitMyData Core, CMake by default will ignore the depends output.** In
...
created. To use it during configuring DebitMyData Core:
...
variables will be set when generating the DebitMyData Core buildsystem. In this case, `-DENABLE_WALLET=OFF`.
