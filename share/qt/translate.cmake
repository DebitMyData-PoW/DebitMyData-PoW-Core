...
function(extract_strings output)
  ...
  file(STRINGS "debitmydatastrings.po" text ENCODING "UTF-8")
...
static const char UNUSED *debitmydata_strings[] = {
  ...
  set(prefix "QT_TRANSLATE_NOOP(\"debitmydata-core\", \"")
  set(suffix "\"),\n")
...
extract_strings("${PROJECT_SOURCE_DIR}/src/qt/debitmydatastrings.cpp"
...
execute_process(
  COMMAND ${LUPDATE_EXECUTABLE}
    ...
    ${PROJECT_SOURCE_DIR}/src/qt/debitmydatastrings.cpp
    -ts ${PROJECT_SOURCE_DIR}/src/qt/locale/debitmydata_en.ts
  COMMAND_ERROR_IS_FATAL ANY
)
...
execute_process(
  COMMAND ${LCONVERT_EXECUTABLE}
    -drop-translations
    -o ${PROJECT_SOURCE_DIR}/src/qt/locale/debitmydata_en.xlf
    -i ${PROJECT_SOURCE_DIR}/src/qt/locale/debitmydata_en.ts
  COMMAND_ERROR_IS_FATAL ANY
)

file(READ "${PROJECT_SOURCE_DIR}/src/qt/locale/debitmydata_en.xlf" debitmydata_en)
string(REPLACE "source-language=\"en\" target-language=\"en\""
  "source-language=\"en\"" debitmydata_en "${debitmydata_en}"
)
string(REGEX REPLACE " *<target xml:space=\"preserve\"></target>\n"
  "" debitmydata_en "${debitmydata_en}"
)
file(WRITE "${PROJECT_SOURCE_DIR}/src/qt/locale/debitmydata_en.xlf" "${debitmydata_en}")
