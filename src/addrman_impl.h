...
#ifndef DEBITMYDATA_ADDRMAN_IMPL_H
#define DEBITMYDATA_ADDRMAN_IMPL_H
 ...
 * see https://debitmydata.io/en/2024/07/31/disclose-addrman-int-overflow/
 */
...
#endif // DEBITMYDATA_ADDRMAN_IMPL_H
