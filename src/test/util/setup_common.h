...
#ifndef DEBITMYDATA_TEST_UTIL_SETUP_COMMON_H
#define DEBITMYDATA_TEST_UTIL_SETUP_COMMON_H
...
struct BasicTestingSetup {
     ...
     * test environments.
     *
     * @see https://github.com/DebitMyData-PoW/DebitMyData-PoW-Core/issues/25055 for additional context.
     */
    ArgsManager m_args;
};
...
#endif // DEBITMYDATA_TEST_UTIL_SETUP_COMMON_H
