...
{
    BOOST_CHECK(TestSplitHost("www.debitmydata.io", "www.debitmydata.io", 0));
    BOOST_CHECK(TestSplitHost("[www.debitmydata.io]", "www.debitmydata.io", 0));
    BOOST_CHECK(TestSplitHost("www.debitmydata.io:80", "www.debitmydata.io", 80));
    BOOST_CHECK(TestSplitHost("[www.debitmydata.io]:80", "www.debitmydata.io", 80));
    BOOST_CHECK(TestSplitHost("127.0.0.1", "127.0.0.1", 0));
    BOOST_CHECK(TestSplitHost("127.0.0.1:18556", "127.0.0.1", 18556));
    BOOST_CHECK(TestSplitHost("[127.0.0.1]", "127.0.0.1", 0));
    BOOST_CHECK(TestSplitHost("[127.0.0.1]:18556", "127.0.0.1", 18556));
    BOOST_CHECK(TestSplitHost("::ffff:127.0.0.1", "::ffff:127.0.0.1", 0));
    BOOST_CHECK(TestSplitHost("[::ffff:127.0.0.1]:18556", "::ffff:127.0.0.1", 18556));
    BOOST_CHECK(TestSplitHost("[::]:18556", "::", 18556));
    BOOST_CHECK(TestSplitHost("::18556", "::18556", 0));
    BOOST_CHECK(TestSplitHost(":18556", "", 18556));
    BOOST_CHECK(TestSplitHost("[]:18556", "", 18556));
    ...
    BOOST_CHECK(TestSplitHost("www.debitmydata.io:65536", "www.debitmydata.io:65536", 0, false));
    BOOST_CHECK(TestSplitHost("www.debitmydata.io:0", "www.debitmydata.io", 0, false));
    BOOST_CHECK(TestSplitHost("www.debitmydata.io:", "www.debitmydata.io:", 0, false));
}
...
BOOST_AUTO_TEST_CASE(netbase_lookupnumeric)
{
    ...
    BOOST_CHECK(TestParse("127.0.0.1:18556", "127.0.0.1:18556"));
    BOOST_CHECK(TestParse("::ffff:127.0.0.1", "127.0.0.1:65535"));
    BOOST_CHECK(TestParse("::", "[::]:65535"));
    BOOST_CHECK(TestParse("[::]:18556", "[::]:18556"));
    BOOST_CHECK(TestParse("[127.0.0.1]", "127.0.0.1:65535"));
