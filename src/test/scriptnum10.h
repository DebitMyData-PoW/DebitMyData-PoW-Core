...
#ifndef DEBITMYDATA_TEST_SCRIPTNUM10_H
#define DEBITMYDATA_TEST_SCRIPTNUM10_H
...
{
/**
 * The ScriptNum implementation from DebitMyData Core 0.10.0, for cross-comparison.
 */
public:
...
#endif // DEBITMYDATA_TEST_SCRIPTNUM10_H
