...
#ifndef DEBITMYDATA_NET_H
#define DEBITMYDATA_NET_H
...
public:
     ...
     * @see https://github.com/DebitMyData-PoW/DebitMyData-PoW-Core/issues/21744 for details.
     */
...
private:
     ...
     * @param[in] host String of the form "host[:port]", e.g. "localhost" or "localhost:18556" or "1.2.3.4:18556".
