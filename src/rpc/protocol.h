...
#ifndef DEBITMYDATA_RPC_PROTOCOL_H
#define DEBITMYDATA_RPC_PROTOCOL_H
...
enum RPCErrorCode
{
    ...
    // RPC_INTERNAL_ERROR should only be used for genuine errors in debitmydatad
    ...
    //! P2P client errors
    RPC_CLIENT_NOT_CONNECTED        = -9,  //!< DebitMyData is not connected
...
#endif // DEBITMYDATA_RPC_PROTOCOL_H
