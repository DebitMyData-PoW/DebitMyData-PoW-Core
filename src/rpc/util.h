...
#ifndef DEBITMYDATA_RPC_UTIL_H
#define DEBITMYDATA_RPC_UTIL_H
...
/**
 * Parse a json number or string, denoting DMD/kvB, into a CFeeRate (sat/kvB).
 * Reject negative values or rates larger than 1DMD/kvB.
 */
