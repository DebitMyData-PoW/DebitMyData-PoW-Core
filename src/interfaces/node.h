...
#ifndef DEBITMYDATA_INTERFACES_NODE_H
#define DEBITMYDATA_INTERFACES_NODE_H
...
//! Top-level interface for a debitmydata node (debitmydatad process).
class Node
{
public:
    ...
    //! Return setting value from <datadir>/settings.json or debitmydata.conf.
...
#endif // DEBITMYDATA_INTERFACES_NODE_H
