...
#ifndef DEBITMYDATA_INTERFACES_INIT_H
#define DEBITMYDATA_INTERFACES_INIT_H
...
//! (debitmydata-gui, debitmydata-node, debitmydata-wallet, debitmydatad, debitmydata-qt) and each
...
#endif // DEBITMYDATA_INTERFACES_INIT_H
