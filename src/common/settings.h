...
#ifndef DEBITMYDATA_COMMON_SETTINGS_H
#define DEBITMYDATA_COMMON_SETTINGS_H
...
//!       https://github.com/DebitMyData-PoW/DebitMyData-PoW-Core/pull/15934/files#r337691812)
...
#endif // DEBITMYDATA_COMMON_SETTINGS_H
