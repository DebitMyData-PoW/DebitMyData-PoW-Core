...
#ifndef DEBITMYDATA_COMMON_ARGS_H
#define DEBITMYDATA_COMMON_ARGS_H
...
extern const char * const DEBITMYDATA_CONF_FILENAME;
extern const char * const DEBITMYDATA_SETTINGS_FILENAME;
...
#endif // DEBITMYDATA_COMMON_ARGS_H
