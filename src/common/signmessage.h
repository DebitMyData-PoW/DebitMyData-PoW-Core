...
#ifndef DEBITMYDATA_COMMON_SIGNMESSAGE_H
#define DEBITMYDATA_COMMON_SIGNMESSAGE_H
 ...
 * @param[in] address Signer's debitmydata address, it must refer to a public key.
...
#endif // DEBITMYDATA_COMMON_SIGNMESSAGE_H
