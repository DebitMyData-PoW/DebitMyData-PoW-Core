...
#ifndef DEBITMYDATA_WALLET_EXTERNAL_SIGNER_SCRIPTPUBKEYMAN_H
#define DEBITMYDATA_WALLET_EXTERNAL_SIGNER_SCRIPTPUBKEYMAN_H
...
#endif // DEBITMYDATA_WALLET_EXTERNAL_SIGNER_SCRIPTPUBKEYMAN_H
