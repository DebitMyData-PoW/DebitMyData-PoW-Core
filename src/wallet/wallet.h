...
#ifndef DEBITMYDATA_WALLET_WALLET_H
#define DEBITMYDATA_WALLET_WALLET_H
...
public:
     ...
     * debitmydata-wallet tool code or by wallet migration code. If this is called
...
#endif // DEBITMYDATA_WALLET_WALLET_H
