...
#ifndef DEBITMYDATA_WALLET_WALLETUTIL_H
#define DEBITMYDATA_WALLET_WALLETUTIL_H
...
enum WalletFlags : uint64_t {
    ...
    //! debitmydata from opening the wallet, thinking it was newly created, and
...
#endif // DEBITMYDATA_WALLET_WALLETUTIL_H
