...
#ifndef DEBITMYDATA_SUPPORT_ALLOCATORS_ZEROAFTERFREE_H
#define DEBITMYDATA_SUPPORT_ALLOCATORS_ZEROAFTERFREE_H
...
#endif // DEBITMYDATA_SUPPORT_ALLOCATORS_ZEROAFTERFREE_H
