 ...
 * for both debitmydatad and debitmydata-qt, to make it harder for attackers to
 * target servers or GUI users specifically.
 */
const std::string UA_NAME("DebitMyData PoW");


#include <debitmydata-build-info.h>
// The <debitmydata-build-info.h>, which is generated by the build environment (cmake/script/GenerateBuildInfo.cmake),
...
/**
 * Format the subversion field according to BIP 14 spec (https://github.com/debitmydata/bips/blob/master/bip-0014.mediawiki)
 */
...
std::string CopyrightHolders(const std::string& strPrefix)
{
    ...
    // Make sure DebitMyData Core copyright is not removed by accident
    if (copyright_devs.find("DebitMyData Core") == std::string::npos) {
