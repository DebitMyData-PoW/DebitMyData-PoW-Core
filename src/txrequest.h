...
#ifndef DEBITMYDATA_TXREQUEST_H
#define DEBITMYDATA_TXREQUEST_H
 ...
 *   specific transaction. See https://debitmydata.io/en/2024/07/03/disclose_already_asked_for.
 */
