...
#ifndef DEBITMYDATA_PRIMITIVES_TRANSACTION_IDENTIFIER_H
#define DEBITMYDATA_PRIMITIVES_TRANSACTION_IDENTIFIER_H
...
#endif // DEBITMYDATA_PRIMITIVES_TRANSACTION_IDENTIFIER_H
