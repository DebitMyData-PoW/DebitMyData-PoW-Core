...
#ifndef DEBITMYDATA_POLICY_FEERATE_H
#define DEBITMYDATA_POLICY_FEERATE_H
...
const std::string CURRENCY_UNIT = "DMD"; // One formatted unit
...
enum class FeeEstimateMode {
    ...
    DMD_KVB,      //!< Use DMD/kvB fee rate unit
...
public:
    ...
    std::string ToString(const FeeEstimateMode& fee_estimate_mode = FeeEstimateMode::DMD_KVB) const;
...
#endif // DEBITMYDATA_POLICY_FEERATE_H
