...
//! that can be used internally by functions in the libdebitmydata_kernel library,
...
#ifndef DEBITMYDATA_KERNEL_TYPES_H
#define DEBITMYDATA_KERNEL_TYPES_H
...
#endif // DEBITMYDATA_KERNEL_TYPES_H
