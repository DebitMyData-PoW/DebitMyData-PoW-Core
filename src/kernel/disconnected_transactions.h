...
#ifndef DEBITMYDATA_KERNEL_DISCONNECTED_TRANSACTIONS_H
#define DEBITMYDATA_KERNEL_DISCONNECTED_TRANSACTIONS_H
...
#endif // DEBITMYDATA_KERNEL_DISCONNECTED_TRANSACTIONS_H
