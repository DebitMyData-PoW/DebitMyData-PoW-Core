...
#ifndef DEBITMYDATA_KERNEL_NOTIFICATIONS_INTERFACE_H
#define DEBITMYDATA_KERNEL_NOTIFICATIONS_INTERFACE_H
...
#endif // DEBITMYDATA_KERNEL_NOTIFICATIONS_INTERFACE_H
