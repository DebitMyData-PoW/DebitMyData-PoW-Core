...
#ifndef DEBITMYDATA_ARITH_UINT256_H
#define DEBITMYDATA_ARITH_UINT256_H
...
public:
     ...
     *
     * DebitMyData only uses this "compact" format for encoding difficulty
...
#endif // DEBITMYDATA_ARITH_UINT256_H
