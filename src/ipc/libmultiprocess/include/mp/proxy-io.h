...
extern thread_local ThreadContext g_thread_context; // NOLINT(debitmydata-nontrivial-threadlocal)
// Silence nonstandard debitmydata tidy error "Variable with non-trivial destructor
