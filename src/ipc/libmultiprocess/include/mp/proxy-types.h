...
//!
//! For example the debitmydata `Coin` class asserts false when a spent coin is
    ...
    decltype(auto) invoke(ServerContext& server_context, TypeList<>, Args&&... args) const
    {
        ...
        return TryFinally(
            ...
            [&] {
                ...
                // described in https://github.com/DebitMyData-PoW/DebitMyData-PoW-Core/issues/34250
