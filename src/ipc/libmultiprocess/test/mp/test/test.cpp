...
{
    // Regression test for debitmydata/debitmydata#34711, debitmydata/debitmydata#34756 where a
...
{
    // Regression test for debitmydata/debitmydata#34777 heap-use-after-free where
...
{
    // Regression test for debitmydata/debitmydata#34782 stack-use-after-return where
