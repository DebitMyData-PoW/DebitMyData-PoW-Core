...
#ifndef DEBITMYDATA_IPC_CAPNP_COMMON_TYPES_H
#define DEBITMYDATA_IPC_CAPNP_COMMON_TYPES_H
...
//! needed to pass transaction objects between debitmydata processes.
...
//! Functions to serialize / deserialize common debitmydata types.
namespace mp {
...
#endif // DEBITMYDATA_IPC_CAPNP_COMMON_TYPES_H
