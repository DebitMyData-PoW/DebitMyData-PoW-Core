...
#ifndef DEBITMYDATA_IPC_PROCESS_H
#define DEBITMYDATA_IPC_PROCESS_H
...
//! IPC process interface for spawning debitmydata processes and serving requests
...
#endif // DEBITMYDATA_IPC_PROCESS_H
