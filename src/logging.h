...
#ifndef DEBITMYDATA_LOGGING_H
#define DEBITMYDATA_LOGGING_H
...
namespace BCLog {
    ...
    public:
         ...
         * Mostly intended for libdebitmydata-kernel apps that don't want any logging.
