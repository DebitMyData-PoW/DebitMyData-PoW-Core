...
#ifndef DEBITMYDATA_NODE_CONNECTION_TYPES_H
#define DEBITMYDATA_NODE_CONNECTION_TYPES_H
 ...
 * src/qt/guiutil.cpp and src/debitmydata-cli.cpp::NetinfoRequestHandler. */
enum class ConnectionType {
     ...
     * Note that in the literature ("Eclipse Attacks on DebitMyData’s Peer-to-Peer Network")
...
#endif // DEBITMYDATA_NODE_CONNECTION_TYPES_H
