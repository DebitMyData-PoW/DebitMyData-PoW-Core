...
#ifndef DEBITMYDATA_SCRIPT_SCRIPT_H
#define DEBITMYDATA_SCRIPT_SCRIPT_H
...
public:
    ...
    /**
     * Pre-version-0.6, DebitMyData always counted CHECKMULTISIGs
...
#endif // DEBITMYDATA_SCRIPT_SCRIPT_H
