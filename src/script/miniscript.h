...
#ifndef DEBITMYDATA_SCRIPT_MINISCRIPT_H
#define DEBITMYDATA_SCRIPT_MINISCRIPT_H
...
//! Parse a miniscript from a debitmydata script
...
#endif // DEBITMYDATA_SCRIPT_MINISCRIPT_H
