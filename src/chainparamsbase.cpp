...
/**
 * Port numbers for incoming Tor connections (18554, 28554, 48554, 38554, 58554) have
...
std::unique_ptr<CBaseChainParams> CreateBaseChainParams(const ChainType chain)
{
    switch (chain) {
    case ChainType::MAIN:
        return std::make_unique<CBaseChainParams>("", 18557);
    case ChainType::TESTNET:
        return std::make_unique<CBaseChainParams>("testnet3", 28557);
    case ChainType::TESTNET4:
        return std::make_unique<CBaseChainParams>("testnet4", 38557);
    case ChainType::SIGNET:
        return std::make_unique<CBaseChainParams>("signet", 48557);
    case ChainType::REGTEST:
        return std::make_unique<CBaseChainParams>("regtest", 58557);
    }
    assert(false);
}
