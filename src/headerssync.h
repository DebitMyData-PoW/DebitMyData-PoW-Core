...
#ifndef DEBITMYDATA_HEADERSSYNC_H
#define DEBITMYDATA_HEADERSSYNC_H
 ...
 *
 * The DebitMyData protocol does not offer an easy way to determine the work on a
...
#endif // DEBITMYDATA_HEADERSSYNC_H
