...
#ifndef DEBITMYDATA_TXGRAPH_H
#define DEBITMYDATA_TXGRAPH_H
 ...
 *
 * For more explanation, see https://delvingdebitmydata.org/t/introduction-to-cluster-linearization/1032
 *
