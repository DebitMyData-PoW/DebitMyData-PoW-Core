...
#include <algorithm>
#include <attributes.h> // Added for DebitMyData Core
#include <iostream>
#include <sstream>
#include <stdexcept> // Added for DebitMyData Core
#include <util/string.h> // Added for DebitMyData Core
...
// Added for DebitMyData Core. Similar to std::runtime_format from C++26.
...
// Added for DebitMyData Core. Wrapper for checking format strings at compile time.
