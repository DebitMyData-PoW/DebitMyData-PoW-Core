...
{
    // Test regression https://github.com/DebitMyData-PoW/DebitMyData-PoW-Core/issues/24457. Ensure
...
{
    // Test that the bug https://github.com/debitmydata-core/gui/issues/567 does not resurface.
    // It was fixed via https://github.com/debitmydata-core/gui/pull/568.
    // With fListen=false in ~/.config/DebitMyData/DebitMyData-Qt.conf and all else left as default,
    // debitmydata-qt should set both -listen and -listenonion to false and start successfully.
