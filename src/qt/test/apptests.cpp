...
//! Entry point for DebitMyDataApplication tests.
void AppTests::appTests()
{
    ...
    connect(&m_app, &DebitMyDataApplication::windowShown, this, &AppTests::guiTests);
...
//! Entry point for DebitMyDataGUI tests.
void AppTests::guiTests(DebitMyDataGUI* window)
{
    HandleCallback callback{"guiTests", *this};
    connect(window, &DebitMyDataGUI::consoleShown, this, &AppTests::consoleTests);
