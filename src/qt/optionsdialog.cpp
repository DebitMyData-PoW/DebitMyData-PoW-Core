      ...
      ui(new Ui::OptionsDialog)
{
    ...
    ui->debitmydataAtStartup->setVisible(false);
    ui->verticalLayout_Main->removeWidget(ui->debitmydataAtStartup);
    ...
    ui->debitmydataAtStartup->setToolTip(ui->debitmydataAtStartup->toolTip().arg(CLIENT_NAME));
    ui->debitmydataAtStartup->setText(ui->debitmydataAtStartup->text().arg(CLIENT_NAME));

    ui->openDebitMyDataConfButton->setToolTip(ui->openDebitMyDataConfButton->toolTip().arg(CLIENT_NAME));
    ...
    ui->unit->setModel(new DebitMyDataUnits(this));
...
{
    /* Main */
    mapper->addMapping(ui->debitmydataAtStartup, OptionsModel::StartAtStartup);
    ...
    mapper->addMapping(ui->m_enable_psbt_controls, OptionsModel::EnablePSDMDontrols);
...
void OptionsDialog::on_openDebitMyDataConfButton_clicked()
{
    ...
    if (!GUIUtil::openDebitMyDataConf())
