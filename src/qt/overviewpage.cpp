...
public:
                      ...
                      const QModelIndex &index ) const override
    {
        ...
        painter->setPen(foreground);
        QString amountText = DebitMyDataUnits::formatWithUnit(unit, amount, true, DebitMyDataUnits::SeparatorStyle::ALWAYS);
        if(!confirmed)
        {
    ...
    DebitMyDataUnit unit{DebitMyDataUnit::DMD};
...
{
    DebitMyDataUnit unit = walletModel->getOptionsModel()->getDisplayUnit();
    ui->labelBalance->setText(DebitMyDataUnits::formatWithPrivacy(unit, balances.balance, DebitMyDataUnits::SeparatorStyle::ALWAYS, m_privacy));
    ui->labelUnconfirmed->setText(DebitMyDataUnits::formatWithPrivacy(unit, balances.unconfirmed_balance, DebitMyDataUnits::SeparatorStyle::ALWAYS, m_privacy));
    ui->labelImmature->setText(DebitMyDataUnits::formatWithPrivacy(unit, balances.immature_balance, DebitMyDataUnits::SeparatorStyle::ALWAYS, m_privacy));
    ui->labelTotal->setText(DebitMyDataUnits::formatWithPrivacy(unit, balances.balance + balances.unconfirmed_balance + balances.immature_balance, DebitMyDataUnits::SeparatorStyle::ALWAYS, m_privacy));
