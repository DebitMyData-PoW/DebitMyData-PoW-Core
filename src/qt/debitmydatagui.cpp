 ...
 *
 * Ref: https://github.com/DebitMyData-PoW/DebitMyData-PoW-Core/pull/1026
 */
static constexpr int64_t MAX_BLOCK_TIME_GAP = 90 * 60;

const std::string DebitMyDataGUI::DEFAULT_UIPLATFORM =
...
DebitMyDataGUI::DebitMyDataGUI(interfaces::Node& node, const PlatformStyle *_platformStyle, const NetworkStyle *networkStyle, QWidget *parent) :
    QMainWindow(parent),
    m_node(node),
    ...
    m_network_style(networkStyle)
{
    ...
    if(enableWallet)
    {
        ...
        connect(walletFrame, &WalletFrame::createWalletButtonClicked, this, &DebitMyDataGUI::createWallet);
    ...
    connect(labelBlocksIcon, &GUIUtil::ClickableLabel::clicked, this, &DebitMyDataGUI::showModalOverlay);
    connect(progressBar, &GUIUtil::ClickableProgressBar::clicked, this, &DebitMyDataGUI::showModalOverlay);
...
void DebitMyDataGUI::createActions()
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a DebitMyData address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and debitmydata: URIs)"));
    ...
    connect(overviewAction, &QAction::triggered, this, &DebitMyDataGUI::gotoOverviewPage);
    connect(sendCoinsAction, &QAction::triggered, [this]{ showNormalIfMinimized(); });
    connect(sendCoinsAction, &QAction::triggered, [this]{ gotoSendCoinsPage(); });
    connect(receiveCoinsAction, &QAction::triggered, [this]{ showNormalIfMinimized(); });
    connect(receiveCoinsAction, &QAction::triggered, this, &DebitMyDataGUI::gotoReceiveCoinsPage);
    connect(historyAction, &QAction::triggered, [this]{ showNormalIfMinimized(); });
    connect(historyAction, &QAction::triggered, this, &DebitMyDataGUI::gotoHistoryPage);
#endif // ENABLE_WALLET
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your DebitMyData addresses to prove you own them"));
    verifyMessageAction = new QAction(tr("&Verify message…"), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified DebitMyData addresses"));
    m_load_psbt_action = new QAction(tr("&Load PSBT from file…"), this);
    m_load_psbt_action->setStatusTip(tr("Load Partially Signed DebitMyData Transaction"));
    m_load_psbt_clipboard_action = new QAction(tr("Load PSBT from &clipboard…"), this);
    m_load_psbt_clipboard_action->setStatusTip(tr("Load Partially Signed DebitMyData Transaction from clipboard"));
    ...
    openAction->setStatusTip(tr("Open a debitmydata: URI"));
    ...
    showHelpMessageAction->setStatusTip(tr("Show the %1 help message to get a list with possible DebitMyData command-line options").arg(CLIENT_NAME));
    ...
    connect(quitAction, &QAction::triggered, this, &DebitMyDataGUI::quitRequested);
    connect(aboutAction, &QAction::triggered, this, &DebitMyDataGUI::aboutClicked);
    connect(aboutQtAction, &QAction::triggered, qApp, QApplication::aboutQt);
    connect(optionsAction, &QAction::triggered, this, &DebitMyDataGUI::optionsClicked);
    connect(showHelpMessageAction, &QAction::triggered, this, &DebitMyDataGUI::showHelpMessageClicked);
    connect(openRPCConsoleAction, &QAction::triggered, this, &DebitMyDataGUI::showDebugWindow);
    ...
    if(walletFrame)
    {
        ...
        connect(openAction, &QAction::triggered, this, &DebitMyDataGUI::openClicked);
        connect(m_open_wallet_menu, &QMenu::aboutToShow, [this] {
            ...
            for (const auto& [path, info] : m_wallet_controller->listWalletDir()) {
                ...
                connect(action, &QAction::triggered, [this, path] {
                    ...
                    connect(activity, &OpenWalletActivity::opened, this, &DebitMyDataGUI::setCurrentWallet, Qt::QueuedConnection);
        ...
        connect(m_restore_wallet_action, &QAction::triggered, [this] {
            ...
            connect(activity, &RestoreWalletActivity::restored, this, &DebitMyDataGUI::setCurrentWallet, Qt::QueuedConnection);
        ...
        connect(m_create_wallet_action, &QAction::triggered, this, &DebitMyDataGUI::createWallet);
        ...
        connect(m_migrate_wallet_menu, &QMenu::aboutToShow, [this] {
            ...
            for (const auto& [wallet_name, info] : m_wallet_controller->listWalletDir()) {
                ...
                connect(action, &QAction::triggered, [this, wallet_name] {
                    ...
                    connect(activity, &MigrateWalletActivity::migrated, this, &DebitMyDataGUI::setCurrentWallet);
        ...
        connect(m_mask_values_action, &QAction::toggled, this, &DebitMyDataGUI::setPrivacy);
        connect(m_mask_values_action, &QAction::toggled, this, &DebitMyDataGUI::enableHistoryAction);
    }
#endif // ENABLE_WALLET

    connect(new QShortcut(QKeySequence(Qt::CTRL | Qt::SHIFT | Qt::Key_C), this), &QShortcut::activated, this, &DebitMyDataGUI::showDebugWindowActivateConsole);
    connect(new QShortcut(QKeySequence(Qt::CTRL | Qt::SHIFT | Qt::Key_D), this), &QShortcut::activated, this, &DebitMyDataGUI::showDebugWindow);
}

void DebitMyDataGUI::createMenuBar()
{
    appMenuBar = menuBar();
...
void DebitMyDataGUI::createToolBars()
{
    if(walletFrame)
    {
        ...
        connect(m_wallet_selector, qOverload<int>(&QComboBox::currentIndexChanged), this, &DebitMyDataGUI::setCurrentWalletBySelectorIndex);
...
void DebitMyDataGUI::setClientModel(ClientModel *_clientModel, interfaces::BlockAndHeaderTipInfo* tip_info)
{
    ...
    if(_clientModel)
    {
        ...
        connect(_clientModel, &ClientModel::numConnectionsChanged, this, &DebitMyDataGUI::setNumConnections);
        connect(_clientModel, &ClientModel::networkActiveChanged, this, &DebitMyDataGUI::setNetworkActive);
        ...
        connect(_clientModel, &ClientModel::numBlocksChanged, this, &DebitMyDataGUI::setNumBlocks);
        ...
        connect(_clientModel, &ClientModel::showProgress, this, &DebitMyDataGUI::showProgress);
...
#ifdef ENABLE_WALLET
void DebitMyDataGUI::enableHistoryAction(bool privacy)
{
...
void DebitMyDataGUI::setWalletController(WalletController* wallet_controller, bool show_loading_minimized)
{
    ...
    GUIUtil::ExceptionSafeConnect(wallet_controller, &WalletController::walletAdded, this, &DebitMyDataGUI::addWallet);
    connect(wallet_controller, &WalletController::walletRemoved, this, &DebitMyDataGUI::removeWallet);
...
WalletController* DebitMyDataGUI::getWalletController()
{
    return m_wallet_controller;
}

void DebitMyDataGUI::addWallet(WalletModel* walletModel)
{
    ...
    connect(wallet_view, &WalletView::outOfSyncWarningClicked, this, &DebitMyDataGUI::showModalOverlay);
    connect(wallet_view, &WalletView::transactionClicked, this, &DebitMyDataGUI::gotoHistoryPage);
    connect(wallet_view, &WalletView::coinsSent, this, &DebitMyDataGUI::gotoHistoryPage);
    connect(wallet_view, &WalletView::message, [this](const QString& title, const QString& message, unsigned int style) {
        this->message(title, message, style);
    });
    connect(wallet_view, &WalletView::encryptionStatusChanged, this, &DebitMyDataGUI::updateWalletStatus);
    connect(wallet_view, &WalletView::incomingTransaction, this, &DebitMyDataGUI::incomingTransaction);
    connect(this, &DebitMyDataGUI::setPrivacy, wallet_view, &WalletView::setPrivacy);
    wallet_view->setPrivacy(isPrivacyModeActivated());
    const QString display_name = walletModel->getDisplayName();
    m_wallet_selector->addItem(display_name, QVariant::fromValue(walletModel));
}

void DebitMyDataGUI::removeWallet(WalletModel* walletModel)
{
...
void DebitMyDataGUI::setCurrentWallet(WalletModel* wallet_model)
{
    if (!walletFrame || !m_wallet_controller) return;
...
void DebitMyDataGUI::setCurrentWalletBySelectorIndex(int index)
{
    WalletModel* wallet_model = m_wallet_selector->itemData(index).value<WalletModel*>();
    if (wallet_model) setCurrentWallet(wallet_model);
}

void DebitMyDataGUI::removeAllWallets()
{
    if(!walletFrame)
        return;
    setWalletActionsEnabled(false);
...
void DebitMyDataGUI::setWalletActionsEnabled(bool enabled)
{
...
void DebitMyDataGUI::createTrayIcon()
{
...
void DebitMyDataGUI::createTrayIconMenu()
{
#ifndef Q_OS_MACOS
    if (!trayIcon) return;
#endif // Q_OS_MACOS
    ...
    show_hide_action = trayIconMenu->addAction(QString(), this, &DebitMyDataGUI::toggleHidden);
...
void DebitMyDataGUI::optionsClicked()
{
    openOptionsDialogWithTab(OptionsDialog::TAB_MAIN);
}

void DebitMyDataGUI::aboutClicked()
{
    if(!clientModel)
        return;
...
void DebitMyDataGUI::showDebugWindow()
{
    GUIUtil::bringToFront(rpcConsole);
    Q_EMIT consoleShown(rpcConsole);
}

void DebitMyDataGUI::showDebugWindowActivateConsole()
{
    rpcConsole->setTabFocus(RPCConsole::TabTypes::CONSOLE);
    showDebugWindow();
}

void DebitMyDataGUI::showHelpMessageClicked()
{
    GUIUtil::bringToFront(helpMessageDialog);
}

#ifdef ENABLE_WALLET
void DebitMyDataGUI::openClicked()
{
...
void DebitMyDataGUI::gotoOverviewPage()
{
    overviewAction->setChecked(true);
    if (walletFrame) walletFrame->gotoOverviewPage();
}

void DebitMyDataGUI::gotoHistoryPage()
{
    historyAction->setChecked(true);
    if (walletFrame) walletFrame->gotoHistoryPage();
}

void DebitMyDataGUI::gotoReceiveCoinsPage()
{
    receiveCoinsAction->setChecked(true);
    if (walletFrame) walletFrame->gotoReceiveCoinsPage();
}

void DebitMyDataGUI::gotoSendCoinsPage(QString addr)
{
    sendCoinsAction->setChecked(true);
    if (walletFrame) walletFrame->gotoSendCoinsPage(addr);
}

void DebitMyDataGUI::gotoSignMessageTab(QString addr)
{
    if (walletFrame) walletFrame->gotoSignMessageTab(addr);
}

void DebitMyDataGUI::gotoVerifyMessageTab(QString addr)
{
    if (walletFrame) walletFrame->gotoVerifyMessageTab(addr);
}
void DebitMyDataGUI::gotoLoadPSBT(bool from_clipboard)
{
    if (walletFrame) walletFrame->gotoLoadPSBT(from_clipboard);
}
#endif // ENABLE_WALLET

void DebitMyDataGUI::updateNetworkState()
{
    ...
    if (m_node.getNetworkActive()) {
        ...
        tooltip = tr("%n active connection(s) to DebitMyData network.", "", count);
    } else {
        //: A substring of the tooltip.
...
void DebitMyDataGUI::setNumConnections(int count)
{
    updateNetworkState();
}

void DebitMyDataGUI::setNetworkActive(bool network_active)
{
    updateNetworkState();
...
void DebitMyDataGUI::updateHeadersSyncProgressLabel()
{
...
void DebitMyDataGUI::updateHeadersPresyncProgressLabel(int64_t height, const QDateTime& blockDate)
{
...
void DebitMyDataGUI::openOptionsDialogWithTab(OptionsDialog::Tab tab)
{
    if (!clientModel || !clientModel->getOptionsModel())
        return;

    auto dlg = new OptionsDialog(this, enableWallet);
    connect(dlg, &OptionsDialog::quitOnReset, this, &DebitMyDataGUI::quitRequested);
...
void DebitMyDataGUI::setNumBlocks(int count, const QDateTime& blockDate, double nVerificationProgress, SyncType synctype, SynchronizationState sync_state)
{
...
void DebitMyDataGUI::createWallet()
{
#ifdef ENABLE_WALLET
    auto activity = new CreateWalletActivity(getWalletController(), this);
    connect(activity, &CreateWalletActivity::created, this, &DebitMyDataGUI::setCurrentWallet);
    connect(activity, &CreateWalletActivity::created, rpcConsole, &RPCConsole::setCurrentWallet);
    activity->create();
#endif // ENABLE_WALLET
}

void DebitMyDataGUI::message(const QString& title, QString message, unsigned int style, bool* ret, const QString& detailed_message)
{
...
void DebitMyDataGUI::changeEvent(QEvent *e)
{
    ...
    if(e->type() == QEvent::WindowStateChange)
    {
        if(clientModel && clientModel->getOptionsModel() && clientModel->getOptionsModel()->getMinimizeToTray())
        {
            ...
            {
                QTimer::singleShot(0, this, &DebitMyDataGUI::hide);
                e->ignore();
            }
            else if((wsevt->oldState() & Qt::WindowMinimized) && !isMinimized())
            {
                QTimer::singleShot(0, this, &DebitMyDataGUI::show);
                e->ignore();
            }
        }
    }
...
void DebitMyDataGUI::closeEvent(QCloseEvent *event)
{
#ifndef Q_OS_MACOS // Ignored on Mac
    if(clientModel && clientModel->getOptionsModel())
    {
...
void DebitMyDataGUI::showEvent(QShowEvent *event)
{
...
#ifdef ENABLE_WALLET
void DebitMyDataGUI::incomingTransaction(const QString& date, DebitMyDataUnit unit, const CAmount& amount, const QString& type, const QString& address, const QString& label, const QString& walletName)
{
    // On new transaction, make an info balloon
    QString msg = tr("Date: %1\n").arg(date) +
                  tr("Amount: %1\n").arg(DebitMyDataUnits::formatWithUnit(unit, amount, true));
...
void DebitMyDataGUI::dragEnterEvent(QDragEnterEvent *event)
{
    // Accept only URIs
...
void DebitMyDataGUI::dropEvent(QDropEvent *event)
{
    if(event->mimeData()->hasUrls())
    {
...
bool DebitMyDataGUI::eventFilter(QObject *object, QEvent *event)
{
...
#ifdef ENABLE_WALLET
bool DebitMyDataGUI::handlePaymentRequest(const SendCoinsRecipient& recipient)
{
    // URI has to be valid
...
void DebitMyDataGUI::setHDStatus(bool privkeyDisabled, int hdEnabled)
{
...
void DebitMyDataGUI::setEncryptionStatus(int status)
{
    switch(status)
    {
...
void DebitMyDataGUI::updateWalletStatus()
{
    assert(walletFrame);
...
void DebitMyDataGUI::updateProxyIcon()
{
    std::string ip_port;
...
void DebitMyDataGUI::updateWindowTitle()
{
...
void DebitMyDataGUI::showNormalIfMinimized(bool fToggleHidden)
{
    if(!clientModel)
        return;
...
void DebitMyDataGUI::toggleHidden()
{
    showNormalIfMinimized(true);
}

void DebitMyDataGUI::detectShutdown()
{
...
void DebitMyDataGUI::showProgress(const QString &title, int nProgress)
{
    if (nProgress == 0) {
...
void DebitMyDataGUI::showModalOverlay()
{
    if (modalOverlay && (progressBar->isVisible() || modalOverlay->isLayerVisible()))
        modalOverlay->toggleVisibility();
}

static bool ThreadSafeMessageBox(DebitMyDataGUI* gui, const bilingual_str& message, unsigned int style)
{
    ...
    if (message.original != message.translated) {
        detailed_message = DebitMyDataGUI::tr("Original message:") + "\n" + QString::fromStdString(message.original);
    }
...
void DebitMyDataGUI::subscribeToCoreSignals()
{
...
void DebitMyDataGUI::unsubscribeFromCoreSignals()
{
...
bool DebitMyDataGUI::isPrivacyModeActivated() const
{
    ...
    : m_platform_style{platformStyle}
{
    ...
    QList<DebitMyDataUnit> units = DebitMyDataUnits::availableUnits();
    int max_width = 0;
    const QFontMetrics fm(font());
    for (const DebitMyDataUnit unit : units) {
        max_width = qMax(max_width, GUIUtil::TextWidth(fm, DebitMyDataUnits::longName(unit)));
    }
...
{
    menu = new QMenu(this);
    for (const DebitMyDataUnit u : DebitMyDataUnits::availableUnits()) {
        menu->addAction(DebitMyDataUnits::longName(u))->setData(QVariant::fromValue(u));
    }
...
void UnitDisplayStatusBarControl::updateDisplayUnit(DebitMyDataUnit newUnits)
{
    setText(DebitMyDataUnits::longName(newUnits));
}
