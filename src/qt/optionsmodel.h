...
#ifndef DEBITMYDATA_QT_OPTIONSMODEL_H
#define DEBITMYDATA_QT_OPTIONSMODEL_H
...
/** Interface from Qt to configuration data structure for DebitMyData client.
...
public:
    ...
    DebitMyDataUnit getDisplayUnit() const { return m_display_debitmydata_unit; }
    QString getThirdPartyTxUrls() const { return strThirdPartyTxUrls; }
    QFont getFontForMoney() const;
    bool getCoinControlFeatures() const { return fCoinControlFeatures; }
    bool getSubFeeFromAmount() const { return m_sub_fee_from_amount; }
    bool getEnablePSDMDontrols() const { return m_enable_psbt_controls; }
...
private:
    ...
    QString language;
    DebitMyDataUnit m_display_debitmydata_unit;
...
Q_SIGNALS:
    void displayUnitChanged(DebitMyDataUnit unit);
...
#endif // DEBITMYDATA_QT_OPTIONSMODEL_H
