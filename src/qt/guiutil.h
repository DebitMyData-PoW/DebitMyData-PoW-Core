...
#ifndef DEBITMYDATA_QT_GUIUTIL_H
#define DEBITMYDATA_QT_GUIUTIL_H
...
/** Utility functions used by the DebitMyData Qt UI.
 */
namespace GUIUtil
{
    ...
    // Parse "debitmydata:" URI into recipient object, return true on successful parsing
...
#endif // DEBITMYDATA_QT_GUIUTIL_H
