...
#ifndef DEBITMYDATA_QT_WALLETMODEL_H
#define DEBITMYDATA_QT_WALLETMODEL_H
...
/** Interface to DebitMyData wallet from Qt view code. */
...
#endif // DEBITMYDATA_QT_WALLETMODEL_H
