...
#ifndef DEBITMYDATA_QT_DEBITMYDATAGUI_H
#define DEBITMYDATA_QT_DEBITMYDATAGUI_H
...
/**
  DebitMyData GUI main class. This class represents the main window of the DebitMyData UI. It communicates with both the client and
  wallet models to give the user an up-to-date view of the current core state.
*/
class DebitMyDataGUI : public QMainWindow
{
    Q_OBJECT
...
public:
    ...
    explicit DebitMyDataGUI(interfaces::Node& node, const PlatformStyle *platformStyle, const NetworkStyle *networkStyle, QWidget *parent = nullptr);
    ~DebitMyDataGUI();
    ...
    */
    ...
    /** Set the wallet model.
        The wallet model represents a debitmydata wallet, and offers access to the list of transactions, address book and sending
        functionality.
    */
...
public Q_SLOTS:
    ...
    void incomingTransaction(const QString& date, DebitMyDataUnit unit, const CAmount& amount, const QString& type, const QString& address, const QString& label, const QString& walletName);
#endif // ENABLE_WALLET
...
public Q_SLOTS:
    ...
    /** Load Partially Signed DebitMyData Transaction from file or clipboard */
...
private Q_SLOTS:
    ...
    void updateDisplayUnit(DebitMyDataUnit newUnits);
    /** Tells underlying optionsModel to update its current display unit. */
    void onMenuSelection(QAction* action);
};

#endif // DEBITMYDATA_QT_DEBITMYDATAGUI_H
