...
#ifndef DEBITMYDATA_TXMEMPOOL_H
#define DEBITMYDATA_TXMEMPOOL_H
 ...
 * DebitMyData-specific logic. Specifically, TxGraph handles (for each transaction)
 ...
 *
 * CTxMemPool itself handles the DebitMyData-specific parts of mempool
