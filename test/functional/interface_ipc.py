...
class IPCInterfaceTest(DebitMyDataTestFramework):
    ...
    def run_unclean_disconnect_test(self):
        ...
        reported https://github.com/DebitMyData-PoW/DebitMyData-PoW-Core/issues/34250, but now just
    ...
    def run_thread_busy_test(self):
        ...
        https://github.com/DebitMyData-PoW/DebitMyData-PoW-Core/issues/33923."""
        node = self.nodes[0]
