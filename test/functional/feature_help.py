...
"""Verify that starting debitmydata with -h works as expected."""

from test_framework.test_framework import DebitMyDataTestFramework
from test_framework.util import assert_equal

class HelpTest(DebitMyDataTestFramework):
    ...
    def run_test(self):
        self.log.info("Start debitmydata with -h for help text")
        ...
        self.log.info("Start debitmydata with -version for version information")
        ...
        self.log.info("Start debitmydatad with -fakearg to make sure it does not start")
