...
class P2PFeelerReceiver(P2PInterface):
    def on_version(self, message):
        # The debitmydatad node closes feeler connections as soon as a version
...
class P2PAddConnections(DebitMyDataTestFramework):
    ...
    def run_test(self):
        ...
        # debitmydatad behaves properly when a version is sent unexpectedly (but
        # tolerably) early.
        #
        # This checks that debitmydatad sends its own version prior to processing
