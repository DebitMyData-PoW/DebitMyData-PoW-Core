...
"""  Tests the mempool:* tracepoint API interface.
     See https://github.com/DebitMyData-PoW/DebitMyData-PoW-Core/blob/master/doc/tracing.md#context-mempool
"""
...
class MempoolTracepointTest(DebitMyDataTestFramework):
