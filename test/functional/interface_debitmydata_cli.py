...
# The block reward of coinbaseoutput.nValue (50) DMD/block matures after
# COINBASE_MATURITY (100) blocks. Therefore, after mining 101 blocks we expect
# node 0 to have a balance of (BLOCKS - COINBASE_MATURITY) * 50 DMD/block.
...
WALLET_NOT_SPECIFIED = (
    ...
    "option before the command (run \"debitmydata-cli -h\" for help or \"debitmydata-cli listwallets\" to see "
...
class TestDebitMyDataCli(DebitMyDataTestFramework):
    ...
    def run_test(self):
        ...
        self.log.info("Compare responses from getblockchaininfo RPC and `debitmydata-cli getblockchaininfo`")
        ...
        # Prevent debitmydata-cli from using existing rpcport in conf
        ...
        self.log.info("Test -getinfo and debitmydata-cli return all proxies")
        ...
        if self.is_wallet_compiled():
            self.log.info("Test -getinfo and debitmydata-cli getwalletinfo return expected wallet info")
            ...
            assert_equal(Decimal(cli_get_info['Transaction fee rate (-paytxfee) (DMD/kvB)']), wallet_info['paytxfee'])
            assert_equal(Decimal(cli_get_info['Min tx relay fee rate (DMD/kvB)']), network_info['relayfee'])
            ...
            # Mine a block to confirm; adds a block reward (50 DMD) to the default wallet.
            ...
            # Test debitmydata-cli -generate with -rpcwallet in multiwallet mode.
...
if __name__ == '__main__':
    TestDebitMyDataCli(__file__).main()
