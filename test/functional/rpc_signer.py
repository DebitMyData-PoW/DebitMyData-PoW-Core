...
Verify that a debitmydatad node can use an external signer command.
...
class RPCSignerTest(DebitMyDataTestFramework):
    ...
    def run_test(self):
        ...
        assert_raises_rpc_error(-1, 'Error: restart debitmydatad with -signer=<cmd>',
