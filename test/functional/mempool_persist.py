...
By default, debitmydatad will dump mempool on shutdown and
...
class MempoolPersistTest(DebitMyDataTestFramework):
    ...
    def run_test(self):
        ...
        self.log.debug("Prevent debitmydatad from writing mempool.dat to disk. Verify that `savemempool` fails")
