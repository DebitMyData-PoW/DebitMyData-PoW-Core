...
def custom_function():
    ...
    # self.log.info("running custom_function")  # Oops! Can't run self.log outside the DebitMyDataTestFramework
    pass


class ExampleTest(DebitMyDataTestFramework):
    # Each functional test is a subclass of the DebitMyDataTestFramework class.
    ...
    def custom_method(self):
        ...
        DebitMyDataTestFramework class so other tests can use it."""
