...
"""  Tests the coin_selection:* tracepoint API interface.
     See https://github.com/DebitMyData-PoW/DebitMyData-PoW-Core/blob/master/doc/tracing.md#context-coin_selection
"""
...
class CoinSelectionTracepointTest(DebitMyDataTestFramework):
