...
class TxnMallTest(DebitMyDataTestFramework):
    ...
    def run_test(self):
        # All nodes should start with 1,250 DMD:
        ...
        # First: use raw transaction API to send 1240 DMD to node1_address,
        # but don't broadcast:
        ...
        # Create two spends using 1 50 DMD coin each
        ...
        # Node0's balance should be starting balance, plus 50DMD for another
        ...
        # Node0's total balance should be starting balance, plus 100DMD for
