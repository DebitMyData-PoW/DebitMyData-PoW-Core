...
class TransactionTimeRescanTest(DebitMyDataTestFramework):
    ...
    def run_test(self):
        ...
        minernode = self.nodes[0]  # node used to mine DMD and create transactions
        ...
        # generate some dmd to create transactions and check blockcount
        ...
        # send 10 dmd to user's first watch-only address
        self.log.info('Send 10 dmd to user')
        ...
        # send 5 dmd to our second watch-only address
        self.log.info('Send 5 dmd to user')
        ...
        # send 1 dmd to our third watch-only address
        self.log.info('Send 1 dmd to user')
