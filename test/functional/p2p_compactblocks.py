...
# TestP2PConn: A peer we use to send messages to debitmydatad, and store responses.
...
class CompactBlocksTest(DebitMyDataTestFramework):
    ...
    # This test actually causes debitmydatad to (reasonably!) disconnect us, so do this last.
    ...
    # debitmydatad's choice of nonce.
    ...
    # Test that debitmydatad requests compact blocks when we announce new blocks
    ...
    def test_incorrect_blocktxn_response(self, test_node):
        ...
        # Note that it's possible for debitmydatad to be smart enough to know we're
    ...
    def test_getblocktxn_handler(self, test_node):
        node = self.nodes[0]
        # debitmydatad will not send blocktxn responses for blocks whose height is
