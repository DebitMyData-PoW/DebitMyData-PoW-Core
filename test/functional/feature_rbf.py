...
class ReplaceByFeeTest(DebitMyDataTestFramework):
    ...
    def test_simple_doublespend(self):
        ...
        reject_details = f"{reject_reason}, rejecting replacement {tx.txid_hex}; new feerate 0.00300000 DMD/kvB <= old feerate 0.00300000 DMD/kvB"
    ...
    def test_doublespend_chain(self):
        ...
        # child fees - 4 DMD - so this attempt is rejected.
