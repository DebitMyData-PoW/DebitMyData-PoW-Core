...
class TestShell:
    """Wrapper Class for DebitMyDataTestFramework.

    The TestShell class extends the DebitMyDataTestFramework
    ...
    class __TestShell(DebitMyDataTestFramework):
        ...
        def setup(self, **kwargs):
            ...
            # by DebitMyDataTestFramework child class.
            self.num_nodes = 1
    ...
    def __new__(cls):
        ...
        if not TestShell.instance:
            # DebitMyDataTestFramework instances are supposed to be constructed with the path
