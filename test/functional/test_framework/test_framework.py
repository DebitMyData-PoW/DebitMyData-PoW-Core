...
class DebitMyDataTestFramework(metaclass=DebitMyDataTestMetaClass):
    ...
    def skip_if_no_debitmydata_bench(self):
        """Skip the running test if bench_debitmydata has not been compiled."""
        if not self.is_bench_compiled():
            raise SkipTest("bench_debitmydata has not been compiled")
    ...
    def is_bench_compiled(self):
        """Checks whether bench_debitmydata was compiled."""
