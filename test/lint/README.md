...
```sh
DOCKER_BUILDKIT=1 docker build -t debitmydata-linter --file "./ci/lint_imagefile" ./ && docker run --rm -v $(pwd):/debitmydata -it debitmydata-linter
```
...
maintained:
* for `src/crc32c`: https://github.com/bitcoin-core/crc32c-subtree.git (branch debitmydata-fork)
* for `src/crypto/ctaes`: https://github.com/bitcoin-core/ctaes.git (branch master)
* for `src/ipc/libmultiprocess`: https://github.com/bitcoin-core/libmultiprocess (branch master)
* for `src/leveldb`: https://github.com/bitcoin-core/leveldb-subtree.git (branch debitmydata-fork)
