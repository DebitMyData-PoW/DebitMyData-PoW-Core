...
maintained:
* for `src/crc32c`: https://github.com/debitmydata-core/crc32c-subtree.git (branch debitmydata-fork)
* for `src/crypto/ctaes`: https://github.com/debitmydata-core/ctaes.git (branch master)
* for `src/ipc/libmultiprocess`: https://github.com/debitmydata-core/libmultiprocess (branch master)
* for `src/leveldb`: https://github.com/debitmydata-core/leveldb-subtree.git (branch debitmydata-fork)
* for `src/minisketch`: https://github.com/debitmydata-core/minisketch.git (branch master)
* for `src/secp256k1`: https://github.com/debitmydata-core/secp256k1.git (branch master)
...
```
git remote add --fetch secp256k1 https://github.com/debitmydata-core/secp256k1.git
```
