...
complete --command debitmydata-qt --no-files

# Extract options
function __fish_debitmydataqt_get_options
...
complete \
    --command debitmydata-qt \
    --arguments "(__fish_debitmydataqt_get_options)"
# Enable file completions only if the commandline now contains a `*.=` style option
complete -c debitmydata-qt \
...
complete \
    --command debitmydata-qt \
    --arguments "(__fish_debitmydataqt_get_options --nofiles)"
