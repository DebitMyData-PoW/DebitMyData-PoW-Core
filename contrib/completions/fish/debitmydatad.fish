...
complete --command debitmydatad --no-files

# Extract options
function __fish_debitmydatad_get_options
...
complete \
    --command debitmydatad \
    --arguments "(__fish_debitmydatad_get_options)"
# Enable file completions only if the commandline now contains a `*.=` style option
complete --command debitmydatad \
...
complete \
    --command debitmydatad \
    --arguments "(__fish_debitmydatad_get_options --nofiles)"
