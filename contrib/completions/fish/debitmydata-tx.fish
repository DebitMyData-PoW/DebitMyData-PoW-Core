...
# Extract options
function __fish_debitmydata_tx_get_options
...
# Extract commands
function __fish_debitmydata_tx_get_commands
...
# Add options
complete \
    --command debitmydata-tx \
    --condition "not __fish_debitmydata_seen_cmd (__fish_debitmydata_tx_get_commands --commandsonly)" \
    --arguments "(__fish_debitmydata_tx_get_options)" \
    --no-files

# Add commands
complete \
    --command debitmydata-tx \
    --arguments "(__fish_debitmydata_tx_get_commands)" \
    --no-files
