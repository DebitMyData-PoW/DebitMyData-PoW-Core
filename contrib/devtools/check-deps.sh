...
declare -A LIBS
LIBS[cli]="libdebitmydata_cli.a"
LIBS[common]="libdebitmydata_common.a"
LIBS[consensus]="libdebitmydata_consensus.a"
LIBS[crypto]="libdebitmydata_crypto.a"
LIBS[node]="libdebitmydata_node.a"
LIBS[util]="libdebitmydata_util.a"
LIBS[wallet]="libdebitmydata_wallet.a"
...
# https://github.com/DebitMyData-PoW/DebitMyData-PoW-Core/issues/10102
