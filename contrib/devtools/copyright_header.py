...
Arguments:
    <base_directory> - The base directory of a debitmydata source code repository.
...
Arguments:
    <file> - A source file in the debitmydata repository.
"""
...
USAGE = """
copyright_header.py - utilities for managing copyright headers of 'The DebitMyData
