...
"""Example logging DebitMyData Core utxo set cache flushes utilizing
    the utxocache:flush tracepoint."""

# USAGE:  ./contrib/tracing/log_utxocache_flush.py path/to/debitmydatad
...
def main(pid):
    ...
    b = BPF(text=program, usdt_contexts=[debitmydatad_with_usdts])
