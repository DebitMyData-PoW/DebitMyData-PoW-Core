...
(define* (make-debitmydata-cross-toolchain target
                                       #:key
...
desirable for building DebitMyData Core release binaries."
...
;; failure; see https://github.com/DebitMyData-PoW/DebitMyData-PoW-Core/pull/27296.
    ...
    (cond ((string-suffix? "-mingw32" target)
          ...
          ((string-contains target "-linux-")
           (list bison
                 ...
                 (make-debitmydata-cross-toolchain target)))
