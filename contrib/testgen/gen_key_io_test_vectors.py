...
bech32_templates = [
  ...
  ('dm',    0, 20, (False, 'main',    None, True), Encoding.BECH32,  p2wpkh_prefix),
  ('dm',    0, 32, (False, 'main',    None, True), Encoding.BECH32,  p2wsh_prefix),
  ('dm',    1, 32, (False, 'main',    None, True), Encoding.BECH32M, p2tr_prefix),
  ('dm',    2,  2, (False, 'main',    None, True), Encoding.BECH32M, (OP_2, 2)),
  ('td',    0, 20, (False, 'test',    None, True), Encoding.BECH32,  p2wpkh_prefix),
  ('td',    0, 32, (False, 'test',    None, True), Encoding.BECH32,  p2wsh_prefix),
  ('td',    1, 32, (False, 'test',    None, True), Encoding.BECH32M, p2tr_prefix),
  ('td',    3, 16, (False, 'test',    None, True), Encoding.BECH32M, (OP_3, 16)),
  ('td',    0, 20, (False, 'signet',  None, True), Encoding.BECH32,  p2wpkh_prefix),
  ('td',    0, 32, (False, 'signet',  None, True), Encoding.BECH32,  p2wsh_prefix),
  ('td',    1, 32, (False, 'signet',  None, True), Encoding.BECH32M, p2tr_prefix),
  ('td',    3, 32, (False, 'signet',  None, True), Encoding.BECH32M, (OP_3, 32)),
  ('dmrt',  0, 20, (False, 'regtest', None, True), Encoding.BECH32,  p2wpkh_prefix),
  ('dmrt',  0, 32, (False, 'regtest', None, True), Encoding.BECH32,  p2wsh_prefix),
  ('dmrt',  1, 32, (False, 'regtest', None, True), Encoding.BECH32M, p2tr_prefix),
  ('dmrt', 16, 40, (False, 'regtest', None, True), Encoding.BECH32M, (OP_16, 40))
]
...
bech32_ng_templates = [
  ...
  ('td',   17, 32, Encoding.BECH32M, False, False, False),
  ('dmrt',  3,  1, Encoding.BECH32M, False, False, False),
  ('dm',   15, 41, Encoding.BECH32M, False, False, False),
  ('td',    0, 16, Encoding.BECH32,  False, False, False),
  ('dmrt',  0, 32, Encoding.BECH32,  True,  False, False),
  ('dm',    0, 16, Encoding.BECH32,  True,  False, False),
  ('td',    0, 32, Encoding.BECH32,  False, True,  False),
  ('dmrt',  0, 20, Encoding.BECH32,  False, False, True),
  ('dm',    0, 20, Encoding.BECH32M, False, False, False),
  ('td',    0, 32, Encoding.BECH32M, False, False, False),
  ('dmrt',  0, 20, Encoding.BECH32M, False, False, False),
  ('dm',    1, 32, Encoding.BECH32,  False, False, False),
  ('td',    2, 16, Encoding.BECH32,  False, False, False),
  ('dmrt', 16, 20, Encoding.BECH32,  False, False, False),
]
