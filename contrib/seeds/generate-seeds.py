...
def main():
    ...
    g = sys.stdout
    indir = sys.argv[1]
    g.write('#ifndef DEBITMYDATA_CHAINPARAMSSEEDS_H\n')
    g.write('#define DEBITMYDATA_CHAINPARAMSSEEDS_H\n')
    g.write('/**\n')
    g.write(' * List of fixed seed nodes for the debitmydata network\n')
    ...
    g.write('#endif // DEBITMYDATA_CHAINPARAMSSEEDS_H\n')
